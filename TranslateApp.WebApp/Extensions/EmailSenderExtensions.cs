...
namespace TranslateApp.WebApp.Services
{
	public static class EmailSenderExtensions
	{
		...
		{
			emailSender.SendEmail(email, "Aktywuj konto",
...
"                            <div style='font-family: \"lato\", \"Helvetica Neue\", Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333;font-weight:bold;'>Witamy!</div>" +
"                          </td>" +
"                        </tr>" +
"                        <tr>" +
...
"</html>"
		...
		public static void SendEmailForgetPasswordAsync(this IEmailSender emailSender, string email, string link)
		{

			emailSender.SendEmail(email, "Resetuj hasło",
			 "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">" +
"<html xmlns=\"http://www.w3.org/1999/xhtml\">" +
"  " +
"  <head>" +
...
"                        <tr>" +
"                          <td align='left' style='padding: 0 56px 28px 56px;' valign='top'>" +
"                            <div style='font-family: \"lato\", \"Helvetica Neue\", Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333;'>Kliknij w poniższy link, aby przejść do procedury resetowania hasła." +
"                          </td>" +
"                        </tr>" +
"                        <tr>" +
"                          <td align='left' style='padding: 0 56px;' valign='top'>" +
